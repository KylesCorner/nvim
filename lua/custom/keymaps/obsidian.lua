...
keymap('n', '<localleader>on', ':ObsidianNew<CR>', { noremap = true, silent = true, desc = 'Create new note' })
...
keymap('n', '<localleader>ot', ':ObsidianTags<CR>', { noremap = true, silent = true, desc = 'Show tags' })
...
keymap('n', '<localleader>oln', ':ObsidianLinks<CR>', { noremap = true, silent = true, desc = 'Show links' })
keymap('n', '<localleader>oc', ':ObsidianToggleCheckbox<CR>', { noremap = true, silent = true, desc = 'Toggle checkbox' })
keymap('n', '<localleader>oft', ':ObsidianNewFromTemplate<CR>', { noremap = true, silent = true, desc = 'New from template' })
